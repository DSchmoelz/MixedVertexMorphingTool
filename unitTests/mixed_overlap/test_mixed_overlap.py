...
#####################################################################
# Test Overlap Mixed Parameterization
#####################################################################
...
class TestMixedSideBySide(unittest.TestCase):
    ...
    def test_mixed_overlap(self):
        ...
        for scaling_type in scaling_types:
            ...
            history_folder = f"unitTests/mixed_overlap/results/history_scaling_{scaling_type}"
            ...
            ## Check Results
            expected = pd.read_csv(f"unitTests/mixed_overlap/ref/history_scaling_{scaling_type}/obj_history.csv")
