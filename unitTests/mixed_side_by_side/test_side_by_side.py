...
#####################################################################
# Test Side by Side Mixed Parameterization
#####################################################################
...
class TestMixedSideBySide(unittest.TestCase):

    def test_mixed_side_by_side(self):
        filter_radius = 4
        blending_filter = 4
        x_limit = 4+24
        nodes_per_x = 1
        ...
        for scaling_type in scaling_types:
            ...
            history_folder = f"unitTests/mixed_side_by_side/results/history_scaling_{scaling_type}"
            ...
            ## Check Results
            expected = pd.read_csv(f"unitTests/mixed_side_by_side/ref/history_scaling_{scaling_type}/obj_history.csv")
