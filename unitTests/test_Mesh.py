...
class TestMesh(unittest.TestCase):
    ...
    def test_add_nodes(self):
        ...
        self.assertEqual(mesh.GetNodeWithId(0).z, 2)
        self.assertEqual(mesh.GetNodeWithId(1).z, 0)
        self.assertEqual(mesh.GetNodeWithId(2).z, 4)
        self.assertEqual(mesh.GetNodeWithId(3).z, 1)
        self.assertEqual(mesh.GetNodeWithId(4).z, 3)
