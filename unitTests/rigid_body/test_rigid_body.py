...
class TestRigidBody(unittest.TestCase):
    ...
    def test_rigid_body(self):
        ...
        for scaling_type in scaling_types:
            ...
            history_folder = f"unitTests/rigid_body/results/history_scaling_{scaling_type}"
            ...
            ## Check Results
            expected = pd.read_csv(f"unitTests/rigid_body/ref/history_scaling_{scaling_type}/obj_history.csv")
